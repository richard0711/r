            ...
            <div class="row">
                <div class="">
                    <div class="text-center">
                        <h3 data-wow-delay="0.1s">Megtalált Hírek a keresett kifejezés alapján: "<?php echo $search_string; ?>"</h3>
                    </div>
                </div>
    ...
    <section data-stellar-background-ratio="1">
        <div class="container">
            <div class="row">
                <div class="">
                    <div class="text-center">
                        <h3 data-wow-delay="0.1s">Megtalált cikkek a keresett kifejezés alapján: "<?php echo $search_string; ?>"</h3>
                    </div>
                </div>
                <div class="clearfix"></div>
    ...
    <section data-stellar-background-ratio="1">
        <div class="container">
            <div class="row">
                <div class="">
                    <div class="text-center">
                        <h3 data-wow-delay="0.1s">Megtalált galériák a keresett kifejezés alapján: "<?php echo $search_string; ?>"</h3>
                    </div>
                </div>
                <div class="clearfix"></div>
                <?php foreach ($search_list["gallery"]["data"] as $gallery) { ?>
                    <div style="margin-top: 20px;" class="col-md-3 col-sm-6">
                        <div class="card-thumb " data-wow-delay="0.2s">
                            ...
                            <div class="services-info">
                                <h5><a href="<?php echo FULL_BASE_URL . 'p/gallery/' . $gallery["idgallery"]; ?>"><?php echo $gallery["name"]; ?></a></h5>
                                <p class="search-list-short-desc">
            ...
            <div class="row">
                <div class="text-center">
                    <div class="about-info">
                        <h2 class=" text-warning" data-wow-delay="0.1s">Nem található, amit keresett!</h2>
                    </div>
                </div>
                <div class="clearfix"></div>
            </div>
