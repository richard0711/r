...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'http://oroszlangyogyszertar.com/rcms/uploaded_files/',
    'root'         => '/web/oroszlangy/oroszlangyogyszertar.com/rcms/uploaded_files/', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
