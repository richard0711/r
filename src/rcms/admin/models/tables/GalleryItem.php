...
class GalleryItem extends CI_Model {
    
    protected $table = "gallery_items";
    protected $primary_key = "idgallery_item";
    ...
    public function get_gallery_items_by_filters($filters = array()){
        ...
        $res = $this->db->get();
        log_message('debug', 'get_gallery_items_by_filters $this->db->last_query()'.print_r($this->db->last_query(), true));
